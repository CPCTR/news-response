...
## 鐵律（凡變更都要遵守）
1. **嚴守 `CONSTITUTION.md` 條目六**：手機/員編/個人聯絡方式一律不得入稿。人名分兩類——**現任公開職務首長/民代**（部長/董事長/廠長/發言人/立委/市議員）可由「長官名單」(`officials.json`) 具名（須正確、不臆測）；**員工/民眾/傷亡者**一律去名（職稱或 ○○○）。RAG 素材庫 (`reference_md_deidentified/`) 仍維持全去名。
